...
class XmlSerializableXmlElementBuilderGenerator extends BuilderGenerator {
  ...
  const XmlSerializableXmlElementBuilderGenerator(
    this._name, {
    String? namespace,
    bool? isSelfClosing,
    bool? includeIfNull,
...
class NullableXmlSerializableXmlElementBuilderGenerator
    extends XmlSerializableXmlElementBuilderGenerator {
  const NullableXmlSerializableXmlElementBuilderGenerator(
    String name, {
    String? namespace,
    bool? isSelfClosing,
    bool? includeIfNull,
