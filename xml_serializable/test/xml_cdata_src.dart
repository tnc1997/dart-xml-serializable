...
builder.cdata(valueSerialized);
}

BoolField _$BoolFieldFromXmlElement(XmlElement element) {
final value = element.getCDATA()!;
...
final value = instance.value;
final valueSerialized = value == true ? 'true' : 'false';
final valueConstructed = XmlCDATA(valueSerialized);
...
if (valueSerialized != null) { builder.cdata(valueSerialized); }
}
...
final value = instance.value;
final valueSerialized = value;
final valueConstructed = valueSerialized != null ? XmlCDATA(valueSerialized) : null;
